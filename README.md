# Star Tribune - TITLE HERE# Star Tribune - Minnesota Poll 2017: State Government
...
1. Get code and enter project: `git clone https://github.com/striblab/20170430-mnpollv3-trump.git && cd 20170430-mnpollv3-trump.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170430-mnpollv3-trump/ && rsync -rav ./ ../20170430-mnpollv3-trump/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
